...
static const struct s5k4ecgx_i2c_reg_conf const s5k4ecgx_focus_step_settings_cfg[][S5K4ECGX_CFG_FOCUS_STEP_MAX_PARAMS] ={
	{
		...
		{0x002A,0x028C, WORD_LEN, 0},
		{0x0F12,0x0004, WORD_LEN, 0},
		{0xFFFF,0x0096, WORD_LEN, 50}, //150}, //P150  
		{0x002A,0x1648, WORD_LEN, 0},
		{0x0F12,0x9002, WORD_LEN, 0},
	},
	{
...
// pz24248 : add presto exposure mode 
static const struct s5k4ecgx_i2c_reg_conf const s5k4ecgx_exposure_settings_cfg[][S5K4ECGX_CFG_EXPOSURE_MAX_PARAMS]={
	{
		// [AE EXPOSURE ->	 Center-Weighted]  (Normal)
		{0xFCFC,0xD000, WORD_LEN, 0},
		{0x0028,0x7000, WORD_LEN, 0},
		{0x002A,0x1492, WORD_LEN, 0},
		{0x0F12,0x0100, WORD_LEN, 0},
		...
		{0x0F12,0x0102, WORD_LEN, 0},
		{0x0F12,0x0101, WORD_LEN, 0},
		{0x0F12,0x0101, WORD_LEN, 0},
		{0x0F12,0x0202, WORD_LEN, 0},
		{0x0F12,0x0202, WORD_LEN, 0},
		{0x0F12,0x0101, WORD_LEN, 0},
		{0x0F12,0x0201, WORD_LEN, 0},
		...
		{0x0F12,0x0101, WORD_LEN, 0},
		{0x0F12,0x0101, WORD_LEN, 0},
		{0x002A,0x0268, WORD_LEN, 0},   //REG_TC_GP_PrevConfigChanged
		{0x0F12,0x0001, WORD_LEN, 50},  //100},
	},
	{
		// [AE EXPOSURE ->	 Average]  (Camcorder)
		{0xFCFC,0xD000, WORD_LEN, 0},
		{0x0028,0x7000, WORD_LEN, 0},
		{0x002A,0x1492, WORD_LEN, 0},
		{0x0F12,0x0101, WORD_LEN, 0},
...
struct s5k4ecgx_reg s5k4ecgx_regs = {
	...
	//exposure
	.exposure_cfg_settings = s5k4ecgx_exposure_settings_cfg,
	.exposure_cfg_settings_size = S5K4ECGX_CFG_EXPOSURE_MAX_PARAMS,
