...
////////========
{SI2C_WR, SI2C_A2D2, 0x0018, 0x4028, 0}, 	// standby_control
{SI2C_POLL_B0AND, SI2C_A2D2, 0x0018, 0x4000, 300},//
//{SI2C_POLL_B1AND, SI2C_A2D2, 0x301a, 0x0004, 100},//                  



{SI2C_WR, SI2C_A2D2, 0x098c, 0x2145}, 	// mcu_address
{SI2C_WR, SI2C_A2D2, 0x0990, 0x02f4 },	// mcu_data_0
{SI2C_WR, SI2C_A2D2, 0x098c, 0xa134 },	// mcu_address
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0001}, 	// mcu_data_0
//
{SI2C_WR, SI2C_A2D2, 0x31e0, 0x0001 },	// pix_def_id
{SI2C_WR, SI2C_A2D2, 0x3400, 0x783C},	// MIPI_CONTROL
{SI2C_WR, SI2C_A2D2, 0x001a, 0x0210 },	// reset_and_misc_control
...
//timing
{SI2C_WR, SI2C_A2D2, 0x001A, 0x0210 }, // RESET_AND_MISC_CONTROL
{SI2C_WR, SI2C_A2D2, 0x001E, 0x0777 },	// PAD_SLEW
{SI2C_WR, SI2C_A2D2, 0x0016, 0x42df },	// clocks_control
{SI2C_WR, SI2C_A2D2, 0x0014, 0x2145 },	// PLL_CONTROL
{SI2C_WR, SI2C_A2D2, 0x0014, 0x2145}, 	// PLL_CONTROL
{SI2C_WR, SI2C_A2D2, 0x0010, 0x0110 },	// PLL_DIVIDERS
{SI2C_WR, SI2C_A2D2, 0x0012, 0x0000}, 	// PLL_P_DIVIDERS
{SI2C_WR, SI2C_A2D2, 0x0014, 0x244B },	// PLL_CONTROL
{SI2C_DELAY, SI2C_A1D1, 0, 0, 50}, //wsh
//{SI2C_DELAY, SI2C_A1D1, 0, 0, 1}, 
{SI2C_WR, SI2C_A2D2, 0x0014, 0x304B}, 	  // pll_control
{SI2C_DELAY, SI2C_A1D1, 0, 0, 50 },             //, timeout=20   // delay=70
{SI2C_WR, SI2C_A2D2, 0x0014, 0xb04a},
{SI2C_DELAY, SI2C_A1D1, 0, 0, 2 },
{SI2C_WR, SI2C_A2D2, 0x3400, 0x7A3C},	// MIPI_CONTROL
//{SI2C_DELAY, SI2C_A1D1, 0, 0, 2},
{SI2C_DELAY, SI2C_A1D1, 0, 0, 50},   //wsh

//reduce_io_current
{SI2C_WR, SI2C_A2D2, 0x098c, 0x02f0 },	// mcu_address
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0000 },	// mcu_data_0
{SI2C_WR, SI2C_A2D2, 0x098c, 0x02f2 },	// mcu_address
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0210 },	// mcu_data_0
{SI2C_WR, SI2C_A2D2, 0x098c, 0x02f4 },	// mcu_address
{SI2C_WR, SI2C_A2D2, 0x0990, 0x001a },	// mcu_data_0

{SI2C_WR, SI2C_A2D2, 0x001A, 0x0010},	// RESET_AND_MISC_CONTROL
{SI2C_WR, SI2C_A2D2, 0x001A, 0x0018},	// RESET_AND_MISC_CONTROL
{SI2C_WR, SI2C_A2D2, 0x321C, 0x0003},	// OFIFO_CONTROL_STATUS
///////===========================
...
{SI2C_WR, SI2C_A2D2, 0x0990, 0x004E, 0},
...
{SI2C_WR, SI2C_A2D2, 0x0990, 0x001F, 0},
{SI2C_WR, SI2C_A2D2, 0x098C, 0xA215, 0},
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0005, 0},
...
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0100, 0},
...
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0010, 0},
{SI2C_WR, SI2C_A2D2, 0x098C, 0xA24F, 0},
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0063, 0},
{SI2C_EOC, SI2C_A1D1, 0, 0, 0},
};
...
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0020, 0},
{SI2C_WR, SI2C_A2D2, 0x098C, 0xA24F, 0},
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0077, 0},
{SI2C_EOC, SI2C_A1D1, 0, 0, 0},
};
...
{SI2C_WR, SI2C_A2D2, 0x0990, 0x0040, 0},
{SI2C_WR, SI2C_A2D2, 0x098C, 0xA24F, 0},
{SI2C_WR, SI2C_A2D2, 0x0990, 0x00A9, 0},
{SI2C_EOC, SI2C_A1D1, 0, 0, 0},
};
