...
#ifdef YAS_ACC_DEFAULT_FILTER_THRESH //P11771_20111020_for Presto
#undef YAS_ACC_DEFAULT_FILTER_THRESH
#define YAS_ACC_DEFAULT_FILTER_THRESH	383060 //506454
#else
#define YAS_ACC_DEFAULT_FILTER_THRESH	383060 //506454
#endif
...
static void yas_bma250_init_data(void)
{
    ...
    acc_data.filter_enable = 1; // 20111012_P11771_default enable 
	acc_data.last.x = 0;
	acc_data.last.y = 0;
	acc_data.last.z = 0;
