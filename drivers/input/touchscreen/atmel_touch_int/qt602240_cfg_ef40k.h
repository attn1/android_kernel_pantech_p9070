...
#define T8_CHRGTIME               	30	// 18	//30
#define T8_TCHDRIFT              	5	//10	//20
#define T8_DRIFTST               	4	//10	//20
...
#define T8_ATCHFRCCALRATIO       	25	//20	//25       
#endif
...
#define T9_AKSCFG                       0
#define T9_BLEN                         16
static uint8_t T9_TCHTHR[4] = {45,35,45,45};	//{45,35,45,46};	//{45,35,40,46};
#define T9_TCHDI                      	3	// 2
#define T9_ORIENT                       5
#define T9_MRGTIMEOUT                   10
#define T9_MOVHYSTI                     10
#define T9_MOVHYSTN                     2
#define T9_MOVFILTER                  0	//18
