...
typedef struct {
  ...
  //?†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÌä∏?†Ïã∏?êÏòô ?†Ïèô?ôÂç†?ôÏòô
  uint32 boot_loader_version_;                // ?†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÂç†?±ÎÑàÎ™åÏòô?†Ïèô???†Ïäπ?êÏòô ?†Ïèô?ôÌä∏?†Ïã∏?êÏòô?†Ïèô???†Ïèô?ôÂç†?ôÏòô
  uint32 boot_section_id_[4];                 // ?†Ïèô?ôÌä∏?†Ïã∏?êÏòô ?†Ïèô?ôÂç†?ôÏòô?†Ïèô???†Ïåï?êÏòô?†Ïèô???†Ïèô?ôÂç†?ôÏòô ?†Ïå•?∏Ïòô?†Ïèô???†Ïèô?ôÂç†?ôÏòô ?†Ïå®?ÑÏñµ???†Ïãπ?êÏòô section id
  
  // ?†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÂç†?ôÏòô EFS ?†Ïèô?ôÂç†?ôÏòô
  uint32              efs_size_;                // ?†Ïèô?ôÏ≤¥ EFS ?†Ïèô?ôÂç†?ôÏòô?†Ïèô??  uint32              partition_num_;           // EFS?†Ïèô???†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÌã∞?†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÂç†?ôÏòô
  partition_info_type partition_info_[ 6 ];     // EFS?†Ïèô???†Ïèô?ôÌã∞?†Ïèô?ôÂç†?ôÏòô ?†Ïèô?ôÂç†?ôÏòô
...
//20110721 choiseulkee add, reboot for PDL IDLE download
    ...
    if(check_phoneinfo() == 1)
    {
      if( memcmp( req->buf, "AT*PHONEINFO*RESET", sizeof("AT*PHONEINFO*RESET")-1) == 0 )
      {
        ...
        // albatros, ?ÖÎç∞?¥Ìä∏??Î∂Ä?ÖÏãú ?úÎ?Î°??∏Ïãù?òÏ? Î™ªÌïò??Í≤ΩÏö∞Í∞Ä ?àÏñ¥???ºÎã® ?§Î•∏Í±∏Î°ú Î∞îÍøîÎ¥?        //machine_restart("oem-33");
